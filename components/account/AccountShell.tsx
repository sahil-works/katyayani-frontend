  ...
  return (
    <main className="min-h-[calc(100vh-96px)] bg-[#f6f7f2] py-10">
      <div className="mx-auto grid w-full max-w-[1320px] gap-6 px-6 lg:grid-cols-[280px_1fr] lg:px-10">
        <aside className="h-fit rounded-2xl border border-[#f5d6e4] bg-white p-4">
        ...
        {status === "initializing" ? (
          ...
          <section className="flex flex-col items-start justify-center rounded-2xl border border-[#f5d6e4] bg-white p-8 sm:p-10">
            ...
            <button
              ...
              className="mt-6 cursor-pointer rounded-xl bg-[#ea206d] px-6 py-3 text-[15px] font-medium text-white transition-colors hover:bg-[#d01b60]"
            >
              Sign in with mobile
            </button>
          </section>
