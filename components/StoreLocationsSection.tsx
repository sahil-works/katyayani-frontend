    ...
    <section className="bg-white py-16">
      <div className="mx-auto w-full max-w-[1320px] px-6 lg:px-10">
        <AnimateOnView animation="fadeInDown" duration={0.75}>
          <h2 className="text-center text-[36px] leading-none font-medium text-[#111]">
            Store Locations
          </h2>
        </AnimateOnView>
        ...
        <div className="mt-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.03fr_1.45fr]">
          ...
          <AnimateOnView animation="fadeInRight" delay={120} duration={0.85}>
            <div className="mb-6">
              <p className="text-[22px] leading-[1.35] font-medium text-[#111] sm:text-[24px]">
                Have a question or need styling advice?
              </p>
              <p className="mt-2 text-[17px] leading-[1.45] text-[#666] sm:text-[18px]">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="mt-1 min-w-[118px] rounded-[5px] bg-[#ea206d] px-5 py-2 text-[21px] font-medium text-white"
              >
                Submit
              </button>
            </form>
